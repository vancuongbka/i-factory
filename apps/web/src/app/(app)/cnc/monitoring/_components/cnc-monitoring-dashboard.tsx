...
const STATUS_STYLES: Record<CncMachineStatus, string> = {
  [CncMachineStatus.RUNNING]:     'bg-green-100 text-green-700 border-green-200',
  [CncMachineStatus.IDLE]:        'bg-gray-100 text-gray-600 border-gray-200',
  [CncMachineStatus.SETUP]:       'bg-blue-100 text-blue-700 border-blue-200',
  [CncMachineStatus.ERROR]:       'bg-red-100 text-red-700 border-red-200',
  [CncMachineStatus.MAINTENANCE]: 'bg-orange-100 text-orange-700 border-orange-200',
};
